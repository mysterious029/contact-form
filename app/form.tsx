  ...
  const contactMethods = [
    {
      ...
      contact: "mukeshmandal9783@gmail.com",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      contact: "Indian Institute of Information Technology Nagpur, India",
    },
  ];
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              {loading ? (
               ...
               Submitting...
                ...
                <>
                <button type="submit" disabled={loading} className="w-full px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150">
                Submit
              </button>
                </>
              )}
